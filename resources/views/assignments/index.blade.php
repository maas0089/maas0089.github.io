        ...
        <table class="table table-hover h-25">
            ...
            @foreach($assignments as $a)
                ...
                <tr>
                    ...
                    <td>{{$a['description']}}</td>
                    <td> <a class="btn btn-secondary btn-sm" href="{{route('opdrachten.show', $a['id'])}}" role="button">Bekijk</a> </td>
                    <td> <a class="btn btn-secondary btn-sm" href="{{route('opdrachten.edit', $a['id'])}}" role="button">Edit</a> </td>
                    <td>
